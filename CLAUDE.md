...
Three files are gitignored because they contain real domains, credentials, or cluster-specific config:
...
5. ArgoCD
6. cloudflared (after ArgoCD and Harbor are reachable internally)
